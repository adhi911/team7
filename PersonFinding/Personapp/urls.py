...
urlpatterns = [
    ...
    path('station/send-enquiry/<int:hospital_id>/', views.station_send_enquiry, name='station_send_enquiry'),
    path('hospital_enquiries_list', views.hospital_enquiries_list, name='hospital_enquiries_list'),
    path('hospital/enquiry/reply/<int:enquiry_id>/', views.hospital_enquiry_reply, name='hospital_enquiry_reply'),
    ...
    path('post_sheet_list', views.post_sheet_list, name='post_sheet_list'),
    path('upload_postmortem_report/<int:case_id>', views.upload_postmortem_report, name='upload_postmortem_report'),
